...
\pnum
\begin{note}
Types can also be named with \grammarterm{typedef-name}{s},
which are introduced by typedef declarations
and \grammarterm{alias-declaration}{s}\iref{dcl.typedef}.
\end{note}
